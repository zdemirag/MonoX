...
physics_processes = {
        'Zll_ht100': { 'label':'QCD Z#rightarrow ll',
                       'datacard':'Zll',
                       'color' : colors.keys()[0],
                       'ordering': 0,                  
                       'xsec' : 148.0,
        ...
        'Zll_ht200': { 'label':'QCD Z#rightarrow ll',
                       'datacard':'Zll',
                       'color' : colors.keys()[0],
                       'ordering': 0,                  
                       'xsec' : 40.94,
        ...
        'Zll_ht400': { 'label':'QCD Z#rightarrow ll',
                       'datacard':'Zll',
                       'color' : colors.keys()[0],
                       'ordering': 0,                  
                       'xsec' : 5.497,
        ...
        'Zll_ht600': { 'label':'QCD Z#rightarrow ll',
                       'datacard':'Zll',
                       'color' : colors.keys()[0],
                       'ordering': 0,                  
                       'xsec' : 2.193,
        ...
        'EWKZ2Jets_ZToNuNu' : { 'label':'EWK Z#rightarrow#nu#nu',
                 'datacard':'ewk_zvv',
                 'color':colors.keys()[8],
                 'ordering': 4,
                 'xsec' : 10.04,
        ...
        'EWKZ2Jets_ZToLL' : { 'label':'EWK Z#rightarrow ll',
                 'datacard':'ewkzll',
                 'color':colors.keys()[7],
                 'ordering': 0,
                 'xsec' : 3.99,
        ...
        'EWKWPlus' : { 'label':'EWK W^{+}#rightarrow  l#nu',
                 'datacard':'ewkwp',
                 'color':colors.keys()[10],
                 'ordering': 3,
                 'xsec' : 25.81,
                 'files':[dataDir+'EWKWPlus2Jets_WToLNu_M-50_13TeV.root',],
                 },       

        'EWKWMinus' : { 'label':'EWK W^{-}#rightarrow  l#nu',
                 'datacard':'ewkwm',
                 'color':colors.keys()[9],
                 'ordering': 3,
                 'xsec' : 20.35,
