#define testZeynep_cxx
#include "testZeynep.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void testZeynep::Loop()
{
...
testZeynep::testZeynep(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/afs/cern.ch/work/z/zdemirag/work/ichep/CMSSW_7_6_4/src/NeroProducer/Nero/test/NeroNtuples.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/afs/cern.ch/work/z/zdemirag/work/ichep/CMSSW_7_6_4/src/NeroProducer/Nero/test/NeroNtuples.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/afs/cern.ch/work/z/zdemirag/work/ichep/CMSSW_7_6_4/src/NeroProducer/Nero/test/NeroNtuples.root:/nero");
...
testZeynep::~testZeynep()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t testZeynep::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t testZeynep::LoadTree(Long64_t entry)
{
...
void testZeynep::Init(TTree *tree)
{
...
void testZeynep::Show(Long64_t entry)
{
...
Int_t testZeynep::Cut(Long64_t entry)
{
