...
MonoJetTree::Reset()
{
  ...
  fatjet1SoftDropM_puppi = -5;
  fatjet1tau21_puppi = -5;
  genDM_pt = -5;
  genDM_eta = -5;
  genDM_phi = -5;
  genDM_mass = -5;
...
MonoJetTree::SetupTree()
{
  ...
  t->Branch("metfilter",&metfilter,"metfilter/I");
  t->Branch("halofilter2015",&halofilter2015,"halofilter2015/I");
  t->Branch("halofilter2016",&halofilter2016,"halofilter2016/I");
  t->Branch("filterbadChCandidate",&filterbadChCandidate,"filterbadChCandidate/I");
  t->Branch("filterbadPFMuon",&filterbadPFMuon,"filterbadPFMuon/I");
  t->Branch("topPtReweighting",&topPtReweighting,"topPtReweighting/F");
  ...
  t->Branch("phoSmearedPt",&phoSmearedPt,"phoSmearedPt/F");
  ...
  t->Branch("jet1nhef",&jet1nhef,"jet1nhef/F");
  t->Branch("jet1chef",&jet1chef,"jet1chef/F");
  ...
  t->Branch("fatjet1PrunedML2L3",&fatjet1PrunedML2L3,"fatjet1PrunedML2L3/F");
  ...
  t->Branch("fatjet1SoftDropM_puppi",&fatjet1SoftDropM_puppi,"fatjet1SoftDropM_puppi/F");
  t->Branch("fatjet1tau21_puppi",&fatjet1tau21_puppi,"fatjet1tau21_puppi/F");
  ...
  t->Branch("rawMet",&rawMet,"rawMet/F");
  t->Branch("caloMet",&caloMet,"caloMet/F");
  t->Branch("trackMet",&trackMet,"trackMet/F");
  t->Branch("neutralMet",&neutralMet,"neutralMet/F");
  t->Branch("photonMet",&photonMet,"photonMet/F");
  t->Branch("HFMet",&HFMet,"HFMet/F");
